...
from nightshift.constants import MODULE_MAP_PATH, MODULE_MAP_STALE_AFTER_SESSIONS
from nightshift.shell import git
from nightshift.types import ModuleMapEntry, ModuleMapSnapshot, RecentSessionChange
...
def render_module_map(snapshot: ModuleMapSnapshot) -> str:
    """Render *snapshot* as markdown for docs/architecture/MODULE_MAP.md."""
    lines = [
        "# Module Map",
        "",
...
def write_module_map(repo_dir: Path, *, snapshot: ModuleMapSnapshot | None = None) -> Path:
    """Write the module map to docs/architecture/MODULE_MAP.md and return the path."""
