...
**Resolved:** 2026-04-08 -- task #0202. Added `count_pending_pentest_framework_tasks` signal to signals.py. pick-role.py now boosts evolve by 40 points when pentest+recursive pending tasks exist, and bypasses the friction-count and cooldown caps. brain.md Delegation Protocol now explicitly documents the pentest-to-evolve path with a worked example.
