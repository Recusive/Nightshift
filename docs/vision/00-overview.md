...
3. Read any feedback from previous runs (in `docs/prompt/feedback/`)
...
- **Feedback loop is explicit**: After testing, the human writes what worked and what didn't into `docs/prompt/feedback/`. The agent reads this next session.
