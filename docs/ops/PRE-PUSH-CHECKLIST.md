...
- [ ] Format matches the template in `docs/handoffs/README.md` exactly
...
- [ ] Entry added to current version file in `docs/changelog/vX.X.X.md`
...
- [ ] Read `docs/vision-tracker/TRACKER.md`
...
- [ ] `docs/ops/OPERATIONS.md` updated with new/changed system
...
- [ ] `docs/vision/00-overview.md` — success criteria or architecture updated if relevant
- [ ] `docs/vision/01-loop1-hardening.md` — roadmap item marked done if completed
- [ ] `docs/vision/02-loop2-feature-builder.md` — open question answered if resolved
...
- [ ] `docs/prompt/evolve.md` updated with the new knowledge
...
- [ ] Check `docs/ops/OPERATIONS.md` version milestones — is the current version complete?
- [ ] If ALL milestone items are done:
  ...
  - [ ] Update `docs/changelog/README.md` table
  - [ ] Create git tag: `git tag vX.X.X`
  - [ ] Push tag: `git push origin vX.X.X`
  - [ ] Create GitHub release: `gh release create vX.X.X --title "vX.X.X -- Codename" --notes-file docs/changelog/vX.X.X.md`
